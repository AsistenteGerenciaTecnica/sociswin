 ...
 */
class modDocPlus extends DolibarrModules
{
	/**
	...
	public function __construct($DB)
	{
		...
		$this->description = "Gestión avanzada de documentos";
		...
		$this->module_parts = array('css' => array('/custom/docplus/css/docplus.css'),'triggers' => 1);
		// Config pages. Put here list of php page names stored in admmin directory used to setup module.
		$this->config_page_url = array('acercade.php@docplus');
		...
		$this->langfiles = array("docplus@docplus");
        ...
        {
        	$conf->docplus = new stdClass();
        	$conf->docplus->enabled = 0;
        }
		...
		$this->menu[$r++]=array(
            ...
            'titre'=>'Documentos +',
            'mainmenu'=>'home',
            'leftmenu'=>'docplus_user',
            'url'=>'/custom/docplus/docplus_user.php',
            'langs'=>'dplus@dplus',
            'position'=>1100+$r,
            'enabled'=>'1',
            'perms'=>1,
		...
		$this->menu[$r++]=array(
            ...
            'titre'=>'Configuración',
            'mainmenu'=>'home',
            'leftmenu'=>'docplus_config',
            'url'=>'/custom/docplus/docplus_config.php',
            'langs'=>'dplus@dplus',
            'position'=>1100+$r,
            'enabled'=>'1',
            'perms'=>1,
